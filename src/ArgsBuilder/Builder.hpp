...
namespace Args
{
    class Builder
    {
        ...
        public:
            Type &value_;
            Param(Type &value, TYPE t, char s, std::string l, std::string d) : AbstractOption(t, s, l, d), value_(value)
            {
            }
        ...
        public:
            bool &value_;
            Flag(bool &value, TYPE t, char s, std::string l, std::string d) : AbstractOption(t, s, l, d), value_(value)
            {
                value_ = false;
            }
    ...
    public:
        ...
        template <class Type> Builder &addOption(Type &value, std::string long_name = "", std::string description = "")
        {
            return addParam(new Param<Type>(value, AbstractOption::OPTION, '\0', long_name, description));
        }
        template <class Type> Builder &addParam(Type &value, std::string long_name = "", std::string description = "")
        {
